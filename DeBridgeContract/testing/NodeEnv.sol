 ...
 * @author Defiant Authors
 * @notice This contract implements a key-value store for storing variables on which defiant nodes must coordinate
 * methods are purposely arbitrary to allow these fields to be defined in defiant improvement proposals.
